/*
 * Start des Programms/Einlesen der User-Datenbank/Aufruf des Login-Fensters
 */
package Main;
...
public class Launch extends javax.swing.JFrame {
    ...
    public Launch(String path) {
        /*
         * Öffnet Auswahlfenster zum Einbinden der User-Datenbank und gibt den absoluten Pfad 
         * an die Klasse DBConnect weiter, um einen Zugriff zur DB zu ermöglichen.
        */
        String fullPath = path;
        conn = DBConnect.ConnectDB(fullPath);
        initComponents();
    }
    ...
    public static void Abfrage(String usr){
        String user = usr;
        usernameString = user;
    ...
    private void registerButonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerButonActionPerformed
        // Methode zum registrieren neuer Benutzer mit Eintrag in der User-Datenbank
        
        
        if (firstnameField.getText().equals("")||lastnameField.getText().equals("")||ageField.getText().equals("")||usernameregisterField.getText().equals("")||passwordregisterField.getText().equals("")||emailField.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Invalit Details\nCeck Input And Try Again!", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        try{

            String sql = "INSERT INTO userdata (firstname, name, email, username, password,age) VALUES (?,?,?,?,?,?)";
            ps = conn.prepareStatement(sql);
            ps.setString(1, firstnameField.getText());
            ps.setString(2, lastnameField.getText());
            ps.setString(3, emailField.getText());
            ps.setString(4, usernameregisterField.getText());
            ps.setString(5, passwordregisterField.getText());
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
        ...
        try{
            ...
            if(rs.next()){
                JOptionPane.showMessageDialog(null, "Connection established\nHello "+usernameString , "Connected", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                JOptionPane.showMessageDialog(null,"The absolute path of the user-database is required.\nPlease select users.sqlite (Projectfolder!)", "Please select!", JOptionPane.INFORMATION_MESSAGE);
                ...
                Launch launch = new Launch(fullPath);
